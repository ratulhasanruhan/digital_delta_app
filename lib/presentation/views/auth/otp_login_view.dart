...
/// Phone → OTP flow; demo code `123456`. Navigates home via [AuthController] on success.
...
class _OtpLoginViewState extends State<OtpLoginView> {
  ...
  Future<void> _verify() async {
    ...
    try {
      ...
      if (!mounted) return;
      if (!ok) {
        setState(() => _error = 'Invalid code. Demo OTP is 123456.');
      }
    } finally {
          ...
          SafeArea(
            child: LayoutBuilder(
              builder: (context, constraints) {
                ...
                Text(
                  _otpStep ? 'Enter verification code' : 'Responder sign-in',
                ...
                Text(
                  _otpStep
                      ? 'We simulate SMS offline. Use code 123456.'
                      : 'Flood disaster management — works offline after login.',
                  style: GoogleFonts.dmSans(
                    fontSize: 15,
                    height: 1.45,
                ...
                FilledButton(
                  ...
                  child: Padding(
                    ...
                    child: _busy
                        ...
                        : Text(
                            _otpStep ? 'Verify & continue' : 'Send OTP',
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          'Offline-first: data syncs when connectivity returns.',
                          style: GoogleFonts.dmSans(
                            fontSize: 13,
                            height: 1.4,
                            color: cs.onSurfaceVariant,
